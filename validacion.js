...
document.addEventListener("DOMContentLoaded", function () {
  ...
  formulario.addEventListener("input", function () {
      ...
      const tel = formulario.querySelector('input[name="telefono"]').value;
      ...
      if (nombre.trim() !== "" && email.trim() !== "" && asunto.trim() !== "" && tel.trim() !== "" && mensaje.trim() !== "") {
...
formulario.addEventListener("submit", function (event) {
    ...
    // Realizar la validación de los campos del formulario aquí
    const nombre = formulario.querySelector('input[name="nombre"]').value;
    const email = formulario.querySelector('input[name="email"]').value;
    const tel = formulario.querySelector('input[name="telefono"]').value;
    const asunto = formulario.querySelector('input[name="asunto"]').value;
...
$(function(){
        ...
        $("#typed").typed({
            strings: ["Desarrollador Web","Desarrollador de Videojuegos","Profesional"], //Strings to display when typing
            typeSpeed: 40,
            backDelay: 600,
            loop: true,
